...
(async () => {
  ...
  try {
    ...
    if (eventType === 'issues') {
      ...
      commentBody = `New issue #${number} created. Please review the details in the tickets/#${number}/evaluation.md file.`;
      ...
      commentBody = `New discussion #${number} created. Please review the details in the tickets/#${number}/evaluation.md file.`;
    }
